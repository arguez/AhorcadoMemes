...
public class Interfaz {
    ...
    private static URL pathSonido;
    private static AudioClip bgdSound;
    ...
    public Interfaz() {
        ...
        try {
            pathSonido = new URL("file:"+System.getProperty("user.dir")+"/src/sfx/track1.wav");
            bgdSound = Applet.newAudioClip(pathSonido);
        }
        catch (Exception e) {   
        }
